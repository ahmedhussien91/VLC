...
# Bit stream constants
NUMBER_OF_BITS_FOR_FRAME_TYPE = 2
NUMBER_OF_BITS_FOR_DCT_STREAM_SIZE = 25
NUMBER_OF_BITS_FOR_MESH_STRUCT_STREAM = 14
NUMBER_OF_BITS_FOR_MOTION_VECTOR_STREAM = 18
NUMBER_OF_BITS_FOR_LAYERS_COUNT = 4
NUMBER_OF_BITS_FOR_INITIAL_MESH_SIZE = 12
NUMBER_OF_BITS_FOR_MESH_STRUCT_COUNT = 7
NUMBER_OF_BITS_FOR_MESH_STRUCT_NODE = 1
